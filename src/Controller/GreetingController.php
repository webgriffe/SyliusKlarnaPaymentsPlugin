...
final class GreetingController extends AbstractController
{
    ...
    {
        return $this->render('@WebgriffeSyliusKlarnaPlugin/static_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }

    public function dynamicallyGreetAction(?string $name): Response
    {
        return $this->render('@WebgriffeSyliusKlarnaPlugin/dynamic_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }
